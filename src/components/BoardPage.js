...
import "../css/boardpagebutton.css";

function BoardPage() {
  return (
    <div>
      <div style={{ "font-weight": 900 }}>
        <h1 style={{ "font-weight": "bold", "font-size": "21px" }}>
          기능 살펴보기
        </h1>
      </div>
      <div>
      ...
      <div>
        <Link to="/view">
          <button className="button1" style={{ "margin-right": "50px" }}>
            ...
            <p
              style={{ "font-size": "12px", position: "relative", top: "33px" }}
            >
              앱에 대한 건의사항 및 불편사항을 공유할 수 있는 페이지입니다
            </p>
          </button>
        </Link>
      </div>
